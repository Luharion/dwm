...
/* tagging */
static const char *tags[] = { " Main[1]", " Coding[2] ", " Firefox [3]", " File Manager[4]", " News[5]", " Study[6]", " Video[7]", " Music[8]", " Email[9]" };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_Insert,	spawn,		SHCMD("xdotool type $(grep -v '^#' ~/.local/share/lis/snippets | dmenu -i -l 50 | cut -d' ' -f1)") },
